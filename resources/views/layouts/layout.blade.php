    ...
    <main>
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
          ...
          <div class="container">
              ...
              <a class="navbar-brand" href="/shop">Boutique</a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <br>
               <li><a  href="{{route('cart.index')}}"><i class="fa fa-shopping-basket" aria-hidden="true"></i><span class="badge badge-pill badge-warning"> {{Cart::count()}}</span></a> </li>
            </ul>
          </div>
         </div>
        </nav>
      ...
      <div id="container">
        ...
        <div id="container">@yield("page_show")</div> 
        <div id="container">@yield("page_shop")</div> 
          
        <div id="container">@yield("sect_contact")</div>

        <div id="container"> @yield("EMP_section")</div> 
        <div id="container">@yield("index_production")</div> 
        <div id="container">@yield("section_occupation") </div>
